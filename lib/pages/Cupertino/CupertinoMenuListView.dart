...
List<Map<String, dynamic>> _items = [
  ...
  { 'title' : 'Push Cupertino Flutter Issues',  'content' : '/cupertinoFlutterIssues' },
  { 'title' : 'Push Cupertino Qiita',  'content' : '/cupertinoQiita' },
  { 'title' : 'Push Cupertino SqliteViewer',  'content' : '/cupertinoSqliteViewer' },
  { 'title' : 'Push Cupertino Flutter Advent Calender',  'content' : '/cupertinoAdvent' },
  { 'title' : 'Push Cupertino Camera',  'content' : '/cupertinoCamera' },
  { 'title' : 'Push Cupertino BarcodeReader',  'content' : '/cupertinoBarcodeReader' },
  { 'title' : 'Push Cupertino Twitter',  'content' : '/cupertinoTwitter' },
  { 'title' : 'Push Cupertino BuildingLayouts',  'content' : '/cupertinoBuildingLayouts' },
  // { 'title' : 'Push Cupertino MenuListView',  'content' : '/cupertinoMenuListView' },
  { 'title' : 'Push Cupertino SharedPreferences',  'content' : '/cupertinoSharedPreferences' },
  ...
  { 'title' : 'Push CupertinoAlertDialog',  'content' : '/cupertinoAlertDialog' },
  { 'title' : 'ush CupertinoTextField',  'content' : '/cupertinoTextField' },
  { 'title' : 'Push CupertinoActionSheet',  'content' : '/cupertinoActionSheet' },
  { 'title' : 'Push CupertinoActivityIndicator',  'content' : '/cupertinoActivityIndicator' },
  ...
  { 'title' : 'Push cupertinoSegmentedControlDemo',  'content' : '/cupertinoSegmentedControlDemo' },
  { 'title' : 'Push CupertinoTimePicker',  'content' : '/cupertinoTimerPicker' },
  { 'title' : 'Push CupertinoLocalAuthentication',  'content' : '/cupertinoLocalAuthentication' },
  { 'title' : 'Push Cupertino SignInButton',  'content' : '/cupertinoSignInButton' },
  { 'title' : 'Push Cupertino CupertinoButton2',  'content' : '/cupertinoButton2' },
  // { 'title' : 'Push Last Day',  'content' : '/lastDayListView' },
